...
<div class="container">
	...
	<form action="/blog/user?cmd=loginProc" method="POST" class="was-validated">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=37e5156c39298e510badea5e563b02af&redirect_uri=http://localhost:8000/blog/oauth/kakao?cmd=callback&response_type=code">
		<img height="38px" src="/blog/image/kakao_login_button.png"></a>
	</form>
</div>
