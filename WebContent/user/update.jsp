...
<div class = "container">
	...
	<form action="/blog/user?cmd=updateProc" name="form" id="form" method="POST" class="was-validated" >
	  ...
	  <div class="form-group">
	    ...
	    <input value="${sessionScope.principal.username}" type="text" class="form-control" id="username" placeholder="Enter username" name="username" readonly="readonly">
	  ...
	  <div class="form-group">
	    ...
	    <input value="${sessionScope.principal.address}" type="text" class="form-control" id="address" placeholder="Enter address" name="address" required readonly="readonly">
	    <div class="valid-feedback">Valid.</div>
	    <div class="invalid-feedback">Please fill out this field.</div>
	  </div>
